				   ...
				   unsigned int flags)
{
	...
	(void)readl(intel_private.registers + GFX_FLSH_CNTL_VLV);
}
...
static const struct intel_gtt_driver_description {
	...
	{ PCI_DEVICE_ID_INTEL_VALLEYVIEW_IG1,
	    "ValleyView", &valleyview_gtt_driver },
	{ PCI_DEVICE_ID_INTEL_VALLEYVIEW_IG2,
	    "ValleyView", &valleyview_gtt_driver },
	{ PCI_DEVICE_ID_INTEL_VALLEYVIEW_IG3,
	    "ValleyView", &valleyview_gtt_driver },
